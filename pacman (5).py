...
# CHANGE 
        for i in range(len(ghost_instances)):
          for j in range(len(monsta_hit_list)):
            if monsta_hit_list[j] in ghost_instances[i]:
              ghost_instances[i].remove(monsta_hit_list[j])
