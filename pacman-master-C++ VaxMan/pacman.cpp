...
#include <iostream>
#include "gameclass.h"  // CHANGE is needed to get access to global variable gameIsLost 
...
{
//    lives--;  // CHANGE - Pacman is immortal
}
...
//    if (lives <= 0 && !flag)
    if ((lives <= 0 || gameIsLost) && !flag)        // CHANGE check that game is lost
    {
        message->setDefaultTextColor(0x00ff00ff);
